...
Either, roll a *d4* to randomly determine a background within an archetype of your choice, or a *d20* to determine a completely random background. Optionally, pick a specific background below from the archetype you wish to follow.
## 4. Name & Age
