...
## Retainers
Retainers are NPCs who will delve into dungeons to adventure and engage in combat. Retainers are more or less devoted followers of a character, and act under their direction. A retainer can be hired for a half share of treasure and XP, and their upkeep costs covered. They will also usually require an upfront payment equal to 5 shillings times their level before signing on, e.g. a level 2 retainer would require 10s. The employer is required to provide all equipment, arms, and armor for the retainer.
...
| PC WIL Score | Retainer Loyalty | Max # |
| :----------: | :--------------: | :---: |
|      3       |        4         |   1   |
|     4-5      |        5         |   2   |
|     6-8      |        6         |   3   |
...
- The heir gains 10% of the dead PC's XP. 

In order to gain this benefit, the PC must share 25% of their personal share of loot and XP with their heir. For example, a party finds a large amount of treasure and a full share is worth 10,000p. Normally the PC would gain 10,000 XP and coin, and the retainer would gain 5,000 XP and coin. If the PC has an heir, they would gain 7,500 XP and coin instead, and the heir would gain an extra 2,500 XP and coin - resulting in both the heir and PC gaining 7,500 XP and coin. If the PC dies the next day, the heir would gain 10% of the PC's XP (750 XP) and add it to their 7,500 XP for a total of 8,250 XP. This decision meant the player only lost 1,750 XP overall (17.5%), instead of 5,000 XP (50%). The PC must be willing to have a slower progression in order to effectively bank XP for their heir.  
### Shares of Treasure
Fractional shares of treasure are calculated by dividing the total amount of treasure by the number of shares. A group of 4 PCs (which each get a full share) and 3 retainers (which each get a half share) would divide the treasure by 5.5. If the party found 2,200p worth of treasure, each PC would get 400p and XP and each retainer would get 200p and XP.
## Mercenaries
